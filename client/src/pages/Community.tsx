      ...
      <div className='px-4 md:px-16 lg:px-24 xl:px-32'>
        {loading ? (
              ...
              {projects.map((project) => (
                <Link key={project.id}
                 ...
                 border-gray-700 rounded-lg overflow-hidden  
                  group  hover:border-indigo-800/80
                    ...
                    >
                      ...
                      <div className="flex gap-3 text-white text-sm">
                        <button
                          ...
                          transition-colors flex item-center gap-2"
                        >
                          <span className='bg-gray-200 size-4.5 rounded-full text-black
                          font-semibold flex items-center justify-center'>{project.user?.name?.slice(0,1)}</span>
                          {project.user?.name}
                        </button>
          ...
          <div className='flex flex-col items-center justify-center h-[80vh]'>
            ...
            <button className='text-white px-5 py-2 mt-5 rounded-md bg-linear-to-br
